...
module Redmine::MenuManager::TopMenu::HelpMenu
  ...
  def render_help_and_support(result)
    ...
    if EnterpriseToken.show_banners?
      result << static_link_item(:upsale, href_suffix: "/?op_edition=community-edition&op_referrer=ee-upsale-help-menu")
    end
  ...
  def render_additional_resources(result)
    ...
    result << static_link_item(:newsletter, href_suffix: "/?op_edition=#{EnterpriseToken.show_banners? ? 'community-edition' : 'enterprise-edition'}&op_referrer=newsletter-help-menu")
